            ...
            <div id="adminNotifDropdown" class="absolute right-0 mt-2 w-80 bg-white dark:bg-surface-dark rounded-xl shadow-2xl border border-slate-200 dark:border-slate-700 hidden z-50 overflow-hidden">
                ...
                <div class="max-h-64 overflow-y-auto">
                    ...
                    <?php else: ?>
                        ...
                        <a href="<?= base_url('admin/arsip/detail/' . esc($notif['id_arsip'])) ?>" class="flex gap-3 p-4 border-b border-slate-50 dark:border-slate-800/50 hover:bg-blue-50 dark:hover:bg-slate-800 transition-colors group">
                ...
                <div class="p-2 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-100 dark:border-slate-800 text-center">
                    <a href="<?= base_url('admin/notifications') ?>" class="text-xs font-bold text-primary dark:text-blue-400 hover:underline">Lihat Semua Log Aktivitas</a>
                </div>
