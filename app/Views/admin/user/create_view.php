...
<head>
    ...
    <title><?= $title ?? 'Add New User' ?> - SiArsip Navigasi</title>
...
<header class="h-16 bg-white dark:bg-surface-dark border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-6 z-20 shadow-sm flex-shrink-0">
    ...
    <div class="flex items-center gap-4">
        <a href="<?= base_url('admin/notifications') ?>" class="relative p-2 rounded-full text-slate-500 hover:bg-slate-100 transition-colors bg-slate-100">
